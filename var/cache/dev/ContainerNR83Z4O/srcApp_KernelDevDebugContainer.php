...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getPropertyControllerService()
    {
        ...
        $this->services['App\\Controller\\PropertyController'] = $instance = new \App\Controller\PropertyController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['serializer'] ?? $this->getSerializerService()));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('O+l-ZegokO', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UTpHykT1bj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'reporting', 'user' => 'root', 'password' => 'test6789', 'unix_socket' => '/tmp/mysql.sock', 'charset' => 'utf8mb4', 'driverOptions' => [], 'serverVersion' => '8.0.18', 'defaultTableOptions' => []], $a, $b, []);
    }
    ...
    /**
     * Gets the private '.service_locator.iQeDhEi' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_IQeDhEiService()
    {
        return $this->privates['.service_locator.iQeDhEi'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.vXm_HJx' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_VXmHJxService()
    {
        return $this->privates['.service_locator.vXm_HJx'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\JobController::add_job' => ['privates', '.service_locator.iQeDhEi', 'get_ServiceLocator_IQeDhEiService', false],
            'App\\Controller\\JobController::index' => ['privates', '.service_locator.0VaU3wd', 'get_ServiceLocator_0VaU3wdService', false],
            'App\\Controller\\JobController:add_job' => ['privates', '.service_locator.iQeDhEi', 'get_ServiceLocator_IQeDhEiService', false],
            'App\\Controller\\JobController:index' => ['privates', '.service_locator.0VaU3wd', 'get_ServiceLocator_0VaU3wdService', false],
        ], [
            'App\\Controller\\JobController::add_job' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-67tqp8pcV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.vXm_HJx'] ?? $this->get_ServiceLocator_VXmHJxService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
